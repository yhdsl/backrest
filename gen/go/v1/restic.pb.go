...
func (x *BackupProgressEntry) GetEntry() isBackupProgressEntry_Entry {
	if x != nil {
		return x.Entry
	}
	return nil
...
func (x *BackupProgressEntry) GetStatus() *BackupProgressStatusEntry {
	if x != nil {
		if x, ok := x.Entry.(*BackupProgressEntry_Status); ok {
			return x.Status
		}
	}
	return nil
...
func (x *BackupProgressEntry) GetSummary() *BackupProgressSummary {
	if x != nil {
		if x, ok := x.Entry.(*BackupProgressEntry_Summary); ok {
			return x.Summary
		}
	}
	return nil
...
const file_v1_restic_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/restic.proto\x12\x02v1\"\xff\x01\n" +
	"\x0eResticSnapshot\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\funix_time_ms\x18\x02 \x01(\x03R\n" +
	"unixTimeMs\x12\x1a\n" +
	"\bhostname\x18\x03 \x01(\tR\bhostname\x12\x1a\n" +
	"\busername\x18\x04 \x01(\tR\busername\x12\x12\n" +
	"\x04tree\x18\x05 \x01(\tR\x04tree\x12\x16\n" +
	"\x06parent\x18\x06 \x01(\tR\x06parent\x12\x14\n" +
	"\x05paths\x18\a \x03(\tR\x05paths\x12\x12\n" +
	"\x04tags\x18\b \x03(\tR\x04tags\x12-\n" +
	"\asummary\x18\t \x01(\v2\x13.v1.SnapshotSummaryR\asummary\"\xd1\x03\n" +
	"\x0fSnapshotSummary\x12\x1b\n" +
	"\tfiles_new\x18\x01 \x01(\x03R\bfilesNew\x12#\n" +
	"\rfiles_changed\x18\x02 \x01(\x03R\ffilesChanged\x12)\n" +
	"\x10files_unmodified\x18\x03 \x01(\x03R\x0ffilesUnmodified\x12\x19\n" +
	"\bdirs_new\x18\x04 \x01(\x03R\adirsNew\x12!\n" +
	"\fdirs_changed\x18\x05 \x01(\x03R\vdirsChanged\x12'\n" +
	"\x0fdirs_unmodified\x18\x06 \x01(\x03R\x0edirsUnmodified\x12\x1d\n" +
	"\n" +
	"data_blobs\x18\a \x01(\x03R\tdataBlobs\x12\x1d\n" +
	"\n" +
	"tree_blobs\x18\b \x01(\x03R\ttreeBlobs\x12\x1d\n" +
	"\n" +
	"data_added\x18\t \x01(\x03R\tdataAdded\x122\n" +
	"\x15total_files_processed\x18\n" +
	" \x01(\x03R\x13totalFilesProcessed\x122\n" +
	"\x15total_bytes_processed\x18\v \x01(\x03R\x13totalBytesProcessed\x12%\n" +
	"\x0etotal_duration\x18\f \x01(\x01R\rtotalDuration\"F\n" +
	"\x12ResticSnapshotList\x120\n" +
	"\tsnapshots\x18\x01 \x03(\v2\x12.v1.ResticSnapshotR\tsnapshots\"\x8e\x01\n" +
	"\x13BackupProgressEntry\x127\n" +
	"\x06status\x18\x01 \x01(\v2\x1d.v1.BackupProgressStatusEntryH\x00R\x06status\x125\n" +
	"\asummary\x18\x02 \x01(\v2\x19.v1.BackupProgressSummaryH\x00R\asummaryB\a\n" +
	"\x05entry\"\xe1\x01\n" +
	"\x19BackupProgressStatusEntry\x12!\n" +
	"\fpercent_done\x18\x01 \x01(\x01R\vpercentDone\x12\x1f\n" +
	"\vtotal_files\x18\x02 \x01(\x03R\n" +
	"totalFiles\x12\x1f\n" +
	"\vtotal_bytes\x18\x03 \x01(\x03R\n" +
	"totalBytes\x12\x1d\n" +
	"\n" +
	"files_done\x18\x04 \x01(\x03R\tfilesDone\x12\x1d\n" +
	"\n" +
	"bytes_done\x18\x05 \x01(\x03R\tbytesDone\x12!\n" +
	"\fcurrent_file\x18\x06 \x03(\tR\vcurrentFile\"\xf8\x03\n" +
	"\x15BackupProgressSummary\x12\x1b\n" +
	"\tfiles_new\x18\x01 \x01(\x03R\bfilesNew\x12#\n" +
	"\rfiles_changed\x18\x02 \x01(\x03R\ffilesChanged\x12)\n" +
	"\x10files_unmodified\x18\x03 \x01(\x03R\x0ffilesUnmodified\x12\x19\n" +
	"\bdirs_new\x18\x04 \x01(\x03R\adirsNew\x12!\n" +
	...
	" \x01(\x03R\x13totalFilesProcessed\x122\n" +
	"\x15total_bytes_processed\x18\v \x01(\x03R\x13totalBytesProcessed\x12%\n" +
	"\x0etotal_duration\x18\f \x01(\x01R\rtotalDuration\x12\x1f\n" +
	"\vsnapshot_id\x18\r \x01(\tR\n" +
	"snapshotId\"[\n" +
	"\x13BackupProgressError\x12\x12\n" +
	"\x04item\x18\x01 \x01(\tR\x04item\x12\x16\n" +
	"\x06during\x18\x02 \x01(\tR\x06during\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"\x95\x02\n" +
	"\x14RestoreProgressEntry\x12!\n" +
	"\fmessage_type\x18\x01 \x01(\tR\vmessageType\x12'\n" +
	"\x0fseconds_elapsed\x18\x02 \x01(\x01R\x0esecondsElapsed\x12\x1f\n" +
	"\vtotal_bytes\x18\x03 \x01(\x03R\n" +
	"totalBytes\x12%\n" +
	"\x0ebytes_restored\x18\x04 \x01(\x03R\rbytesRestored\x12\x1f\n" +
	"\vtotal_files\x18\x05 \x01(\x03R\n" +
	"totalFiles\x12%\n" +
	"\x0efiles_restored\x18\x06 \x01(\x03R\rfilesRestored\x12!\n" +
	"\fpercent_done\x18\a \x01(\x01R\vpercentDone\"\xe0\x01\n" +
	"\tRepoStats\x12\x1d\n" +
	"\n" +
	"total_size\x18\x01 \x01(\x03R\ttotalSize\x126\n" +
...
var (
	...
	file_v1_restic_proto_rawDescData []byte
)

func file_v1_restic_proto_rawDescGZIP() []byte {
	file_v1_restic_proto_rawDescOnce.Do(func() {
		file_v1_restic_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_restic_proto_rawDesc), len(file_v1_restic_proto_rawDesc)))
	})
...
func file_v1_restic_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_restic_proto_rawDesc), len(file_v1_restic_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
